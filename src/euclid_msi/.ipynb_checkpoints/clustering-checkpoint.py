...
acronyms = # a numpy array or pandas series of anatomical acronyms, one pixel at a time
lipizones = # a numpy array or pandas series of lipizones (clusters) names, one pixel at a time, PARALLEL to acronyms, extract from the anndata object in case
